Конечно. За время работы над экшеном мы добавили поддержку генерации `changelog`, логику релизных/пререлизных веток и полностью перешли на архитектуру `composite`. Старый файл больше не отражает всех возможностей.

Вот полностью обновленный `README.md`, который описывает все новые входные и выходные параметры:
